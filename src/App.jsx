...
const PERSONA_DOMAINS={plant_leader:["Safety","Quality","Production","Maintenance","Planning"],maint_manager:["Maintenance","Safety"],scheduler:["Planning"],quality_manager:["Quality"],safety_lead:["Safety"]};
